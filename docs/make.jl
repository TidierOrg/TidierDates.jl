...
DocTestMeta = quote
    using TidierData, TidierDates, Dates
end
DocMeta.setdocmeta!(TidierDates,
    :DocTestSetup,
    DocTestMeta;
    recursive=true)
makedocs(
...
deploydocs(; repo="github.com/TidierOrg/TidierDates.jl.git", push_preview=true,
